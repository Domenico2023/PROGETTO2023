...
namespace SortLibrary {
  ...
  template<typename T>
  vector<T> HeapBuild(vector<T>& v, unsigned int maxI=0);
  template<typename T>
  ...
  inline ostream &operator<<(ostream &os, const DecreasingInt &obj) {os << obj.value; return os;}
  inline bool operator==(const DecreasingInt &obj1, const DecreasingInt &obj2) {return obj1.value == obj2.value;}
  inline bool operator!=(const DecreasingInt &obj1, const DecreasingInt &obj2) {return !(obj1 == obj2); }
  inline bool operator<(const DecreasingInt &obj1, const DecreasingInt &obj2) {return obj1.value > obj2.value;}
  inline bool operator>(const DecreasingInt &obj1, const DecreasingInt &obj2) {return obj1.value < obj2.value;}
  inline bool operator<=(const DecreasingInt &obj1, const DecreasingInt &obj2) {return obj1.value >= obj2.value;}
  inline bool operator>=(const DecreasingInt &obj1, const DecreasingInt &obj2) {return obj1.value <= obj2.value;}
