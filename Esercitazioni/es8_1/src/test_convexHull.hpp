...
TEST(UnitTest, TestUpperLine)
{
    ...
    bool b = UpperLine(points[0], points[1], points[2]);
...
TEST(TestConvexHull, TestHulls)
{
  unsigned int numPoints = 0;
  vector<Point> points = {Point(1, 1, numPoints++),
                          Point(2, 3, numPoints++),
                          Point(3, 4, numPoints++),
                          Point(4, 1, numPoints++),
                          Point(5, 3, numPoints++)};
  ...
  points[2].succ = &points[3];
  points[3].prec = &points[2];
  points[4].succ = &points[2];
  points[2].prec = &points[4];
  points[3].succ = &points[4];
  points[4].prec = &points[3];
  ...
  while(p != &points[0])
  {convexHull.push_back(*p); p = p->succ;}
  ...
  string rightConveHull = "0 3 4 2 1 ";
